...
txt_wind_heading =					txt_add("---", "size:28px; font:my737glass.otf; color:white; halign:left;", 5, 35, 65, 31) visible(txt_wind_heading,false)
...
function temp (track_mag_pilot, irs_mode, mcp_hdg_dial, current_heading, map_range, traffic_ra, traffic_ta, tcas_on)	
	if 		map_range == 0 then
...
xpl_dataref_subscribe("sim/cockpit2/gauges/indicators/ground_track_mag_pilot", "FLOAT",
					  ...
					  "laminar/B738/EFIS/tcas_on", "INT", temp)
